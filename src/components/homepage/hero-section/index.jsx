        ...
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <div className="my-12 flex items-center gap-5">
            ...
            <Link
              ...
              aria-label={`${personalData.name} facebook profile`}
              target="_blank"
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              <FaFacebook size={30} />
            ...
            <Link
              ...
              aria-label={`${personalData.name} leetcode profile`}
              target="_blank"
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              <SiLeetcode size={30} />
            ...
            <Link
              ...
              aria-label={`${personalData.name} X profile`}
              target="_blank"
              className="transition-all text-pink-500 hover:scale-125 duration-300"
            >
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                {skillsData?.map((skill, id) => (
                  <React.Fragment key={id}>
                    ...
                    <span tabIndex="-1" className="text-amber-300">
                      {skill}
                    </span>
                    <span tabIndex="-1" className="text-gray-400">
                      {"'"}
